...
public class ReationOperator {
	public static void main(String[] args) {
		/*비교 연산자: 결과를 true, false를 리턴(되돌려 줌)
		  	- 크기 비교 연산자: >, <, >=, <=
		  	- 등가 비교 연산자: ==(같으면 true), !=(같지 않으면 false)
		...
		//2. 참조 자료형일 때 등가 비교 연산자 사용
			//객체변수명(str1): stack 메모리 영역에 저장, str1 = 값이 저장된 heap의 주소를 가지고 있음
		...
		//참조 자료형일 때 Heap 영역의 값을 비교: .equals()를 사용해서 값을 비교
		...
		System.out.println(str3 == str4);		//==는 stack에 변수의 값을 비교
