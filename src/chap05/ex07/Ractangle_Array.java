...
public class Ractangle_Array {
	...
	public static void main(String[] args) {
		...
		//3. 배열 변수 선언 시 값을 바로 할당: 방크기를 지정하면 오류 발생 	*주의*
...
//		System.out.println(Arrays.toString(arr6[3]));	//오류 발생: 배열의 방번호[index]를 넘김
		...
		int[][] arr8;
//		arr8 = {{1, 2, 3}, {11, 22, 33}, {111, 222, 333}};		//오류 발생 arr8 = new int[][] {}
